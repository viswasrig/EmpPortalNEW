...
IM.Price*IM.NumOfUnits AS Amount, IM.ReceivedAmount, IM.ReceivedDate
FROM Invoice_Master IM
JOIN Assignment_Master ASM ON IM.AssignmentID = ASM.ID AND (IM.RecStatus='P' && IM.ReceivedDate IS NOT NULL)
